...
=======================
Async sensor concurrency engine for safe parallel sensor dispatch.

Sensors self-declare concurrency safety, and the orchestrator automatically
batches consecutive safe sensors into parallel groups while running unsafe
sensors serially.
...
MAX_CONCURRENCY = 10   # maximum parallel sensor dispatches
