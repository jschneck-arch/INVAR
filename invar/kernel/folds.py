...
from invar.intel.gap_detector import detect_from_events, detect_from_web_fingerprints
from invar.identity import parse_workload_ref
...
class FoldDetector:
    ...
    def detect_structural(self, events_dir: Path,
        ...
        """
        try:
            from invar.intel.gap_detector import detect_from_events
            from invar.intel.gap_detector import KNOWN_SERVICES
        except ImportError:
            return []
